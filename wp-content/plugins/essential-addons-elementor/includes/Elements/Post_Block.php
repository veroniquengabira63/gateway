...
class Post_Block extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $settings = [
            ...
            'eael_post_block_layout'    => $settings['eael_post_block_layout'],
            'eael_post_tiled_preset'    => $settings['eael_post_tiled_preset'],
            'eael_post_tiled_column'    => $settings['eael_post_tiled_column'],
            'eael_show_fallback_img'    => $settings['eael_show_fallback_img'],
            'eael_post_block_fallback_img'    => $settings['eael_post_block_fallback_img'],
        ];
