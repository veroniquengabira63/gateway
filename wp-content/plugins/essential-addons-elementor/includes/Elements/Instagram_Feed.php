...
class Instagram_Feed extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'eael_instafeed_background',
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name'     => 'eael_instafeed_overlay_box_border',
                'label'    => esc_html__('Border', 'essential-addons-elementor'),
                'selector' => '{{WRAPPER}} .eael-instafeed-img, {{WRAPPER}} .eael-instafeed-caption',
                'condition' => [
                    'eael_instafeed_layout' => 'overlay'
                ]
            ]
        ...
        $this->add_control(
            'eael_instafeed_box_overaly_layout_border_radius',
            [
                'label'     => esc_html__('Border Radius', 'essential-addons-elementor'),
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-overlay .eael-instafeed-item-inner .eael-instafeed-img, {{WRAPPER}} .eael-instafeed-overlay .eael-instafeed-item-inner .eael-instafeed-caption' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                ],
                'condition' => [
                    'eael_instafeed_layout' => 'overlay'
                ]
        ...
        $this->add_control(
            'eael_instafeed_box_overaly_padding',
            [
                'label' => __('Content Padding', 'essential-addons-elementor'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed.eael-instafeed-overlay .eael-instafeed-caption' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
                    'eael_instafeed_layout' => 'overlay'
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-caption .eael-instafeed-icon i' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'eael_instafeed_layout' => 'overlay',
                ],
        ...
        $this->add_control(
            'eael_instafeed_username_style_heading',
            [
                'label' => __('User Name Styles', 'essential-addons-elementor'),
                'type'  => Controls_Manager::HEADING,
            ]
        );
        $this->add_control(
            'eael_instafeed_username_color',
            [
                'label'     => esc_html__('Color', 'essential-addons-elementor'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-card .eael-instafeed-item .eael-instafeed-item-inner .eael-instafeed-item-header .eael-instafeed-item-user .eael-instafeed-username' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'eael_instafeed_username_typography',
                'scheme'   => Scheme_Typography::TYPOGRAPHY_2,
                'selector' => '{{WRAPPER}} .eael-instafeed-card .eael-instafeed-item .eael-instafeed-item-inner .eael-instafeed-item-header .eael-instafeed-item-user .eael-instafeed-username',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '#ffffff',
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed.eael-instafeed-overlay .eael-instafeed-caption-text, {{WRAPPER}} .eael-instafeed.eael-instafeed-card .eael-instafeed-caption-text' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'eael_instafeed_layout' => 'overlay',
                ],
        ...
        $this->add_control(
            'eael_instafeed_card_caption_color',
            [
                'label'     => esc_html__('Caption Color', 'essential-addons-elementor'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#000000',
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed.eael-instafeed-card .eael-instafeed-caption-text' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'eael_instafeed_layout'     => 'card',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme'   => Scheme_Typography::TYPOGRAPHY_2,
                'selector' => '{{WRAPPER}} .eael-instafeed-caption-text',
            ]
        );
        $this->add_control(
            'eael_instafeed_caption_alignment',
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-caption-text' => 'text-align: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'eael_instafeed_date_style_heading',
            [
                'label' => __('Date Styles', 'essential-addons-elementor'),
                'type'  => Controls_Manager::HEADING,
            ]
        );

        $this->add_control(
            'eael_instafeed_date_color',
            [
                'label'     => esc_html__('Date Color', 'essential-addons-elementor'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-item-inner .eael-instafeed-post-time, {{WRAPPER}} .eael-instafeed-item-inner .eael-instafeed-post-time i' => 'color: {{VALUE}};',
                ],
                'condition' => [
                    'eael_instafeed_layout' => 'card',
                ],
        ...
        $this->add_control(
            'eael_instafeed_overlay_date_color',
            [
                'label'     => esc_html__('Date Color', 'essential-addons-elementor'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ffffff',
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name'     => 'eael_instafeed_date_typography',
                'scheme'   => Scheme_Typography::TYPOGRAPHY_2,
                'selector' => '{{WRAPPER}} .eael-instafeed-item-inner .eael-instafeed-post-time',
            ]
        );
        $this->add_control(
            'eael_instafeed_box_date_alignment',
            [
                'label' => __('Date Aignment', 'essential-addons-elementor'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'essential-addons-elementor'),
                ...
                'condition' => [
                    'eael_instafeed_layout' => 'card',
                    'eael_instafeed_card_style' => 'inner'
                ],
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-item-footer' => 'text-align: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'eael_instafeed_box_overlay_date_alignment',
            [
                'label' => __('Date Aignment', 'essential-addons-elementor'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                ...
                'condition' => [
                    'eael_instafeed_layout' => 'overlay',
                    'eael_instafeed_overlay_style' => 'basic'
                ],
                'selectors' => [
                    '{{WRAPPER}} .eael-instafeed-meta' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_tab(
            'eael_instafeed_load_more_btn_normal',
        ...
        // Hover State Tab
        $this->start_controls_tab(
            'eael_instafeed_load_more_btn_hover',
